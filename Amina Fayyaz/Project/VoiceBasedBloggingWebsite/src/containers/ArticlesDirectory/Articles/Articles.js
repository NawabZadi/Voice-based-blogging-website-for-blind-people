...
const Articles = (props) => {
  ...
  const commands = [
    ...
    },
    {
      ...
      callback: async () => {
        ttsSpeak(
          'The available commands are: CREATE NEW ARTICLE, OPEN, delete, opn all articles, open my articles, Scroll up, scroll down, speak articles, help and say out to logout. Speak now'
        );
      },
